...
def main():
	...
	## Setup some paths
	training_args.overall_results_path = "{}/{}/results.txt".format(training_args.output_dir, data_args.dataset_name)
	if data_args.target_wise:
		training_args.output_dir = "{}/{}/target_{}".format(training_args.output_dir, data_args.dataset_name, data_args.fold)
	else:
		training_args.output_dir = "{}/{}/split_{}".format(training_args.output_dir, data_args.dataset_name, data_args.fold)
